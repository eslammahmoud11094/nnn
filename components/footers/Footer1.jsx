...
export default function Footer1() {
  return (
    <div className="footer-style-3">
      ...
      <div className="rainbow-contact-section pt--60 pb--60">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              <h2 className="title">Get in Touch</h2>
              <p className="section-subtitle">
                Ready to build a workplace your people will love? Let’s talk.
              </p>
              <ul className="contact-info list-unstyled d-inline-flex flex-column align-items-center">
                <li className="mb-2">
                  <i className="feather-mail me-2" />
                  Email: <a href="mailto:info@talentlyme.com">info@talentlyme.com</a>
                </li>
                <li className="mb-2">
                  <i className="feather-globe me-2" />
                  Website:{' '}
                  <a href="https://www.talentlyme.com" target="_blank" rel="noopener noreferrer">
                    www.talentlyme.com
                  </a>
                </li>
                <li className="mb-2">
                  <i className="feather-map-pin me-2" />
                  Location: Abu Dhabi, UAE. Corniche Road. Al Sawari Tower B
                </li>
                <li className="mb-2">
                  <i className="feather-clock me-2" />
                  Working Hours: Monday – Friday: 8:00 AM to 5:00 PM (Closed on Saturday & Sunday)
                </li>
              </ul>
                    ...
                    <a
                      ...
                      href=""
                    >
                      Get in Touch <i className="icon feather-arrow-right" />
                    </a>
                  </div>
            </div>
          </div>
