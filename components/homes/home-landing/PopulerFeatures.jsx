            ...
            <div className="row mb--40">
              <div className="col-lg-12">
                <div className="section-title  text-center sal-animate">
                  <h4 className="theme-gradient">Our Services</h4>

                  <p className="description b1">
                    We serve <i> both</i> organizations and individuals — from
                    strategic consulting for companies to personal career
                    coaching CV depevelopment and interview preparation for
                    professionals.
                  </p>
                </div>
              </div>
            ...
            <div className="row g-5">
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
                <div className="service service__style--1 bg-color-blackest radius text-center rbt-border">
                  ...
                  <div className="content">
                    <h4 className="title w-600">
                      <a href="#">Strategic HR Consulting</a>
                    </h4>
                    <p className="description b1 color-gray mb--0">
                      HR audits, culture design, engagement strategy, and policy
                      development.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
                <div className="service service__style--1 bg-color-blackest radius text-center rbt-border">
                  ...
                  <div className="content">
                    ...
                    <p className="description b1 color-gray mb--0">
                      Sourcing, shortlisting, employer branding, and onboarding
                      planning.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
                <div className="service service__style--1 bg-color-blackest radius text-center rbt-border">
                  ...
                  <div className="content">
                    <h4 className="title w-600">
                      <a href="#">Employee Experience Design</a>
                    </h4>
                    <p className="description b1 color-gray mb--0">
                      Employee experience mapping, performance systems, feedback
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
                <div className="service service__style--1 bg-color-blackest radius text-center rbt-border">
                  ...
                  <div className="content">
                    ...
                    <p className="description b1 color-gray mb--0">
                      Coaching, leadership training, performance reviews,
                      succession planning.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6 col-12 sal-animate">
                <div className="service service__style--1 bg-color-blackest radius text-center rbt-border">
                  ...
                  <div className="content">
                    <h4 className="title w-600">
                      <a href="#">Wellbeing & Inclusion</a>
                    </h4>
                    <p className="description b1 color-gray mb--0">
                      Mental health programs, diversity strategy, and workplace
                      wellness.{" "}
                    </p>
                  </div>
                </div>
