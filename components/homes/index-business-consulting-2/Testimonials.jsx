...
export default function Testimonials() {
  ...
  return (
    <div className="rainbow-testimonial-area rainbow-section-gap" id="testimonials">
      <div className="container">
        <div className="row mb--20">
          <div className="col-lg-12">
            ...
            >
              ...
              <h2 className="title w-600 mb--20">Testimonials.</h2>
        ...
        <Slider
          className="row rainbow-slick-dot rainbow-slick-arrow testimonial-activation row"
          data-sal="slide-up"
            ...
            <div className="col-lg-12" key={index}>
              ...
              <div className="testimonial-style-two">
                <div className="row align-items-center row--20">
                  <div className="order-2 order-md-1 col-lg-11 col-md-8 offset-lg-1">
